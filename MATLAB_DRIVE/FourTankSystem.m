...
% % 4-tank system.%% Syntax: xdot = FourTankSystem(t,x,u,p)% Unpack states, MVs, and parameters
...
% % Inflow
qin = zeros(4,1);qin(1,1) = gamma(1)*F(1);        % Inflow from valve 1 to tank 1 [cm3/s]
